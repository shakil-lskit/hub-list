...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ asset("frontend/vendor_assets/css/brands.css") }}">
    <link rel="stylesheet" href="{{ asset("frontend/vendor_assets/css/fontawesome.min.css") }}">
    <link rel="stylesheet" href="{{ asset("frontend/vendor_assets/css/jquery-ui.css") }}">
    <link rel="stylesheet" href="{{ asset("frontend/vendor_assets/css/jquery.mCustomScrollbar.css") }}">
    <link rel="stylesheet" href="{{ asset("frontend/vendor_assets/css/line-awesome.min.css") }}">
    <link rel="stylesheet" href="{{ asset("frontend/vendor_assets/css/magnific-popup.css") }}">
    <link rel="stylesheet" href="{{ asset("frontend/vendor_assets/css/owl.carousel.min.css") }}">
  ...
  <body>
    ...
    @inertia
     ...
     <script src="{{asset("frontend/vendor_assets/js/jquery.mCustomScrollbar.concat.min.js")}}"></script>
     <script src="{{asset("frontend/vendor_assets/js/jquery.waypoints.min.js")}}"></script>
     <script src="{{asset("frontend/vendor_assets/js/masonry.pkgd.min.js")}}"></script>
     ...
     <script src="{{asset("frontend/theme_assets/js/locator.js")}}"></script>
